...
export default function Login({ inpts, setInpts, setUserId, setLogedUser }) {
    ...
    const createUser = () => {
        ...
        JSON.stringify(localStorage.setItem('inpt', user))
            ...
            <form className="mx-auto mb-0 mt-8 max-w-md space-y-4">
                ...
                <div className="flex items-center justify-between">
                    <p className="text-sm text-gray-500">
                        ...
                        <Link className="underline ml-2" to="/Rejister">
                            login
                        </Link>
                    </p>
